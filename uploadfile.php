...
//Application Title
define('APP_TITLE', 'Chipsy File Manager');
...
$auth_users = array(
    'admin' => '$2y$10$uUOKmTLhNN1GKsD6MJ8id.bhCWDYRMX2LRrb5OEXnhaUn5Qbt44QS', //admin@123
    'chipsy' => '$2y$10$Q6zsbNd7IGpMTTkU/l3MjOwl3mNeo26gaqixMYSG6dofVWuSZUDsm', //12345
    'user'  => '$2y$10$Q6zsbNd7IGpMTTkU/l3MjOwl3mNeo26gaqixMYSG6dofVWuSZUDsm'
);
...
$favicon_path = 'https://www.chipsyservices.com/Website/assets/images/Frame 6.png';

// Files and folders to excluded from listing
// e.g. array('myfile.html', 'personal-folder', '*.php', ...)
$exclude_items = array('uploadfile.php');
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <!-- <svg version="1.0" xmlns="https://www.chipsyservices.com/Website/assets/images/c-logo.webp" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="Chipsy File Manager">
                                            ...
                                            <img src="https://www.chipsyservices.com/Website/assets/images/c-logo.webp" alt="Chipsy File manager" style="width: 100px;">
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://www.chipsyservices.com/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Chipsy IT Services Pvt. Ltd</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Chipsy File Manager <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Chipsy File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Chipsy File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
